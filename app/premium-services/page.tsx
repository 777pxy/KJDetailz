    ...
    <section className="min-h-screen px-4 py-12 md:px-8 md:py-24">
      <div className="mx-auto max-w-[1100px]">
        <div className="mb-12 text-center md:mb-20">
          ...
          <div className="mb-3 flex items-center justify-center gap-2 pt-2 text-primary">
          ...
          <p className="text-lg text-muted-foreground md:text-xl">
            Our most meticulous work, reserved for owners who accept nothing
          ...
          <div className="mt-4 inline-flex items-center gap-3 rounded-md border border-border/60 bg-muted/40 px-4 py-3 w-fit">
            ...
            <span className="text-xs text-muted-foreground tracking-wide">
              Fully insured · Mobile across Dorset · By appointment
            </span>
          </div>
        </div>
